...
dashApp.layout = dbc.Container(fluid=True, style={'direction': 'rtl', 'backgroundColor': "#F8F9FA"}, children=[
    ...
    dbc.Modal(
    id='modal',
    # size='md',  # Increased size to extra-large to take up more screen space
    is_open=False,
    children=[
        dbc.ModalHeader(
            dbc.ModalTitle(""),
            close_button=True,  # Keep close button visible for easy closing
            style={
                "backgroundColor": "#F8F9FA",
